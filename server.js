...
app.use("/api/retailDrugs", require('./routes/retailDrugs'));
app.use("/api/wholesaleDrugs", require('./routes/wholesaleDrugs'));
...
app.get('/', (req, res) => {
  res.header("Access-Control-Allow-Origin", "*").send('API now running 🥳');
});
